...
export const translations = {
  es: {
    ...
    locationCardSub: "Ubicación, parking, horario y contacto",
    address: "Dirección",
  ...
  en: {
    ...
    locationCardSub: "Location, parking,hours and contact",
    address: "Address",
  ...
  fr: {
    ...
    locationCardSub: "Localisation, parking, horaires et contact",
    address: "Adresse",
